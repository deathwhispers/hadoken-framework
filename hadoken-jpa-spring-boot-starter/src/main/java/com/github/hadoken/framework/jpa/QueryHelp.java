package com.github.hadoken.framework.jpa;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.ObjectUtil;
import com.github.hadoken.common.util.string.StringUtils;
import com.github.hadoken.framework.jpa.annotation.DataPermission;
import com.github.hadoken.framework.jpa.annotation.Query;
        ...
        if (permission != null) {
            ...
            if (CollectionUtil.isNotEmpty(dataScopes)) {
                if (StringUtils.isNotBlank(permission.joinName()) && StringUtils.isNotBlank(permission.fieldName())) {
                    Join<Object, Object> join = root.join(permission.joinName(), JoinType.LEFT);
