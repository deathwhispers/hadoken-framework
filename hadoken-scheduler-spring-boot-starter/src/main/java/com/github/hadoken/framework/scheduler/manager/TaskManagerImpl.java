package com.github.hadoken.framework.scheduler.manager;

import com.github.hadoken.framework.scheduler.autoconfigure.HadokenSchedulerProperties;
import com.github.hadoken.framework.scheduler.enums.TaskSourceType;
import com.github.hadoken.framework.scheduler.enums.TaskStatus;
import com.github.hadoken.framework.scheduler.lock.DistributedLockProvider;
import com.github.hadoken.framework.scheduler.model.ManagedTask;
import com.github.hadoken.framework.scheduler.model.TaskDefinition;
...
public class TaskManagerImpl implements TaskManager {
    ...
    public Runnable registerAndSync(TaskDefinition definition, Runnable originalRunnable) {
        ...
        ManagedTask managedTask = new ManagedTask(definitionToUse,
                ...
                this.lockProviderOpt, this.taskLogStore
        );
        runtimeTasks.put(definition.getId(), managedTask);
    ...
    private ManagedTask resolveTaskDefinition(TaskDefinition definition) {
        ...
        try {
            ...
            return new ManagedTask(definition,
                    runnable,
                    this.instanceId,
                    properties.getLogRetentionSize(),
